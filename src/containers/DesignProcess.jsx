...
const DesignProcess = () => {
	return (
		<section className="my-28 lg:my-32">
			...
			>
				<div className="flex flex-col gap-x-4 gap-y-8 min-[360px]:flex-row min-[360px]:flex-wrap min-[360px]:justify-center xsm:gap-x-7 xsm:gap-y-14 md:gap-20 xl:gap-[7rem]">
